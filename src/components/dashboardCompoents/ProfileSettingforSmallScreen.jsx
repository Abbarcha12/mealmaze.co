...
const PasswordModelSmallScreen = () => {
  ...
  return (
    <React.Fragment >
      ...
      />
      <Box p={2} sx={{display:{lg:"none"}}}>
      <Grid container mt={2}>
          <img src={Logo} alt='logo' height={"22px"} />
        </Grid>
      <Grid container mt={3} p={2} sx={{backgroundColor:"#fff",boxShadow:"0px 4px 26px 0px rgba(0, 132, 44, 0.06)",borderRadius:"16px"}}>
        ...
        <InputLabel htmlFor='standard-adornment-amount' className='Label1'>
        ...
        <Box display={"flex"} justifyContent={"space-between"} mt={5} width="100%">
          <Box>
            <Button sx={{
