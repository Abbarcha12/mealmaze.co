      ...
      <Modal
        ...
        <Box sx={{ ...style, width: 400 }}>
          <Box sx={{background:"#16A34A"}} p={2}>
            <Typography sx={{fontSize:"20px",fontWight:"600 !important",color:"#fff"}}>
            Delete Account
            </Typography>
          </Box>
          <Box p={2}>
          <Typography sx={{fontSize:"17px",fontWight:"500 !important",color:"#6C7275"}}>
          <span style={{fontSize:"20",fontWight:"600 !important",color:"#EF4444"}}>
          Warning:
            </span> Deleting your Accounts will permanently remove all of your data and cannot be undone.
            </Typography>
            <Box>
